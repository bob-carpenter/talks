...
\item at time of \myemph{symtpom onset}: they are \myemph{maximized}
...
\begin{subitemize}
\item calculated using \texttt{\bfseries loo} package in R
\item binomial w.\ \myemph{log link} models \myemph{exponential clearance}
\item \myemph{monotonic shrinkage} very \myemph{flexible} within constraint
\end{subitemize}
...
\sld{\vspace*{-4pt}Professional basketballers}

\includegraphics[width=0.7\textwidth]{img/bball-days-from-peak.png}
\begin{subitemize}
\vspace*{-3pt}
\item all players \myemph{tested positive}
\vspace*{-3pt}
\item \myemph{symptomatic} in red; \ \myemph{asymptomatic} in blue
\vspace*{-3pt}
