...
# Part IV: Coding Functions in Stan
...
# Part V:  Coding Functions in C++ (Templated)

## Code produced by Stan transpiler
...
# Part V: 
## What does the transpiled C++ look like?
...
## Coding the distribution in C++ with 

- Like Stan, but with explicit templates and references
- Template `y` and assume `mu` and `sigma` are `double`
