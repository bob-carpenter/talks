...
The following is an abridged version of Stan program `gen_magic8.stan`:
...
## RStan workflow, command `print(<stanfit>)`
...
## RStan workflow, commands `extract`, `as.array`, `as.matrix`, `as.data.frame`
