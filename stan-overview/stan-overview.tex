...
\item Need large step size to explore mouth of funnel (high
  hierarchical variance)
\item Need small step size to explore neck of funnel
  (low hierarchical variance)
...
\end{eqnarray*}
\item Removes dependency of $\beta$ and $\sigma$ in prior
\item Posterior of $\beta$ and $\log \sigma$ independent normal
\begin{subitemize}
\item this is how plot of independent draws was generated
\end{subitemize}
\end{itemize}
