...
\item \myemph{Split $\hat{R}$}: \ Stan splits each chain into first and
  second half
\begin{subitemize}
\item creates $2M$ chains of $N/2$ draws
\item splitting diagnoses non-stationarity
\end{subitemize}
\end{itemize}
...
\mypart{Interlude}{Conjugate Priors}
...
\mypart{Example}{Repeated Binary Trials}
...
\mypart{Example}{Hierarchical Models}
...
\mypart{Prerequisite}{Maximum Likelihood \\[8pt]\spc Estimation}
...
\mypart{Deep Dive}{Autodiff Coding}
...
\mypart{Challenges}{Modeling and Computing}
