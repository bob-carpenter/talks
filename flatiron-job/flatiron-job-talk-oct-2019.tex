...
\item Of the days on which a 75\% of rain is forecast, 75\% of them
should be rainy. 
\begin{subitemize}
...
\begin{subitemize}
\item Will it \myemph{rain in Edinburgh} on any given day of the year?  (52\%)
...
\begin{subitemize}
\item Meaning they capture the true data-generating process.
...
\item \myemph{Goal}: keep extending the efficient frontier
\begin{subitemize}
